function [ground_matrix,neigbor_matrix,neigbor_num_matrix,neigbor_pos_matrix,neigbor_pos_vectorid,Vector_pos_to_neigbor_vector_pos,Vector_pos_to_neigbor_num]= mean_spatial_kernel(img,window_width,GroundT)
%MEAN_SPATIAL_KERNEL 此处显示有关此函数的摘要
%   此处显示详细说明
